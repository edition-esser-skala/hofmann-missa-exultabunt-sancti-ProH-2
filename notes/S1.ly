...
AgnusSopranoNotes = {
  \relative c' {
    ...
    R1*8 %8
    r2 \mvTr e'4.\pE^\solo e8
    e d r f f e r e %10
    e f16 g f8 e e d d e16([ d)]
    d8 c e d16([ c)] h4 c8([ dis)]
    e2 e4 r
    R1
    r4 \mvTr e8\fE^\tutti e8 e4 e8 e %15
    d4 d8 d dis4. dis8
    e4 e8 e e4 e8 e
    e4 d8 d d4. d8
    d4 c8 c c4. c8
...
DonaSopranoNotes = {
  \relative c' {
    ...
    c([ d)] e8[( d)] c4.( h8)
    a4 d d r8 d
    c[ d e d] c4 \once \tieDashed d~
    d8[ c] h[ c16 d] e4 r %30
    R1*2
    c2 c
    d4. e8 f([ e f d]
    e[ d]) c4 r8 e16[ d] c8[ h] %35
    a4 h8[ c] d[ e16 d] c8[ d]
    g,4 c8([ d] e[ c d e])
    d4 r d2
    d d
    d h4 h %40
    a2 g4 r
    r8^\critnote h4 h8 c4( e)
    d2 d8[ c] \once \tieDashed h4~
    h8 c4 h8 c[ d] e4
    R1*2 %46
    r2 h
    h c4. d8
